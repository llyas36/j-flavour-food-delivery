    ...
    <section class="categories">
        <div class="container">
            ...
            <div class="grid-3">
                ...
                <a href="category-foods.php">
                    <div class="float-container">
                        <img src="img/category/kitfo.jpg" class="img-responsive" alt="">
                        <h3 class="float-text text-white">Kitfo</h3>
                    </div>
                </a>
                <a href="category-foods.php">
                    <div class="float-container">
                        <img src="img/category/ayinet.jpg" class="img-responsive" alt="">
                        <h3 class="float-text text-white">Beayinet</h3>
                    </div>
                </a>
                <a href="category-foods.php">
                    <div class="float-container">
